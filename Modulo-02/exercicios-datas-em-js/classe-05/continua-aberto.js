...
console.log(taAberto(new Date(2021, 3, 25, 12))); //false
console.log(taAberto(new Date(2021, 3, 26, 12))); //true
console.log(taAberto(new Date(2021, 3, 26, 7, 59))); //false
console.log(taAberto(new Date(2021, 3, 24, 9, 30))); //true
